...
public final class SqlFormatter {
    ...
    private static class Formatter extends AstVisitor<Void, Integer> {
        ...
        @Override
        public Void visitAlterClusterDecommissionNode(DecommissionNodeStatement decommissionNodeStatement, Integer indent) {
            append(indent, "ALTER CLUSTER DECOMMISSION ");
            append(indent, decommissionNodeStatement.nodeIdOrName().toString());
            return null;
        }
